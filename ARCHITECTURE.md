...
| Multi-block drag | Partial | Dragging a selected block now moves the selected set through the existing reorder pipeline, but preview/gesture UX is still single-anchor oriented |
