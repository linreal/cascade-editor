 ...
 *
 * Provided by [CascadeEditor] from the [SlashCommandSlot] parameter and read by
 * [io.github.linreal.cascade.editor.ui.renderers.TextBlockField] to decide whether
 * to construct a [io.github.linreal.cascade.editor.slash.SlashCommandTextObserver]
